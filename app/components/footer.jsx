    ...
    <footer className="bg-black dark:bg-white text-white dark:text-black">
      ...
      <div className="p-8 flex justify-around items-center sm:block">
        ...
        <div className="flex sm:justify-center md:justify-between">
          ...
          <Link
            href="https://www.linkedin.com/in/charitha-meka-6a7ab0165/"
            target="_blank"
            className=" hover:text-gray-900 dark:hover:text-sky-300 mx-5"
          >
            <svg
          ...
          <Link
            href="https://github.com/charitha-gmu"
            target="_blank"
            className=" hover:text-gray-900 dark:hover:text-sky-300 mx-5"
          >
            <svg
          ...
          <div className="mx-3">
            <Link href="/documents/Sree_Charitha_Meka_Resume_Final.pdf" target="_blank">
              <button
                className={
                  resolvedTheme === "white"
